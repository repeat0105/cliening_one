...
// js media와 load시 deviece(ipadpc) 사용 배움
...
function inputValueChange () {
    ididvalval =  document.getElementById('id').value;
    console.log(ididvalval === '')
    ididvalval.value =null;
}
...
let newWord;
let dbfyrkddml = document.querySelector('#dbfyrkddml');


const onClickButton = () => {
        clienSideNum= localStorage.setItem('clienSideNum', newWord)
...
dbfyrkddml.addEventListener('click', onClickButton);
